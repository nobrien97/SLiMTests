...
GDATAPATH=/g/data/ht96/nb9894/h2_ext
SCRATCHPATH=/scratch/ht96/nb9894/h2_ext/getH2
...
if [ -f $HOME/tests/h2_ext/getH2/done/${RUN}_${CHUNK} ]; then
...
if [ $(ls $HOME/tests/h2_ext/getH2/done/*_${CHUNK} | wc -l) == 2016 ]; then
