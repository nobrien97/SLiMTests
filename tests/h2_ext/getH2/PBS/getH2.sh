...
# Make output folder
mkdir /scratch/ht96/nb9894/h2_ext/getH2
mkdir /g/data/ht96/nb9894/h2_ext/getH2
mkdir $HOME/tests/h2_ext/getH2/done

SAVEDIR=/g/data/ht96/nb9894/h2_ext/getH2
...
CMDS_PATH=$HOME/tests/h2_ext/getH2/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/h2_ext/getH2
