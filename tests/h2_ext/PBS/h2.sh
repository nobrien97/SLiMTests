...
# Make output folder
mkdir /scratch/ht96/nb9894/h2_ext
mkdir /g/data/ht96/nb9894/h2_ext
mkdir $HOME/tests/h2_ext/done

# Pre-job file manipulation goes here ...
# 
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/h2_ext
...
CMDS_PATH=$HOME/tests/h2_ext/PBS/cmds.txt
