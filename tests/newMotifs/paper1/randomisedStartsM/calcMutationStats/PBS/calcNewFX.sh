...
ECHO=/bin/echo
SUBJOBNAME=newMotifs/paper1/randomisedStartsM
...
CMDS_PATH=$HOME/tests/$TOTALJOBNAME/PBS/cmds_new_fx.txt
...
cat ./d_fx_new_* >> $SAVEDIR/d_fx_new.csv
...
# 
    ...
    cd $PBS_O_WORKDIR
    qsub -v NJOBS=$NJOBS,NJOB=$NJOB ./calcNewFX.sh
else
