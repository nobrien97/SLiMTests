...
WRITE_PATH_MRR <- paste0("/scratch/ht96/nb9894/newMotifs/paper1/randomisedStartsM/getH2/out_h2_", run_chunk, "_mrr.csv")
WRITE_PATH_MKR <- paste0("/scratch/ht96/nb9894/newMotifs/paper1/randomisedStartsM/getH2/out_h2_", run_chunk, "_mkr.csv")

WRITE_PATH_TRAIT_MRR <- paste0("/scratch/ht96/nb9894/newMotifs/paper1/randomisedStartsM/getH2/out_h2_", run_chunk, "_trait_mrr.csv")
WRITE_PATH_TRAIT_MKR <- paste0("/scratch/ht96/nb9894/newMotifs/paper1/randomisedStartsM/getH2/out_h2_", run_chunk, "_trait_mkr.csv")
