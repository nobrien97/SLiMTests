# R Script to calculate additive variance without any scaling
library(bWGR)
library(purrr)
...
JOB_PATH <- "newMotifs/paper1/randomisedStartsM"

WRITE_PATH_MRR <- paste0("/scratch/ht96/nb9894/", JOB_PATH, "/getH2/out_h2_", run_chunk, "_noscale_mrr.csv")
WRITE_PATH_MKR <- paste0("/scratch/ht96/nb9894/", JOB_PATH, "/getH2/out_h2_", run_chunk, "_noscale_mkr.csv")

WRITE_PATH_TRAIT_MRR <- paste0("/scratch/ht96/nb9894/", JOB_PATH, "/getH2/out_h2_", run_chunk, "_noscale_trait_mrr.csv")
WRITE_PATH_TRAIT_MKR <- paste0("/scratch/ht96/nb9894/", JOB_PATH, "/getH2/out_h2_", run_chunk, "_noscale_trait_mkr.csv")
...
relPheno_mat <- as.matrix(relPheno_dat)
...
# Run kernel regression w/ eigendecomposition depending on the model
relFitness_mat <- as.matrix(relFitness_dat)
...
# Run kernel regression w/ eigendecomposition depending on the model
relTraits_mat <- as.matrix(relTraits_dat)
