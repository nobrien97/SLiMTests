...
path <- "/mnt/c/GitHub/SLiMTests/tests/newMotifs/paper1/randomisedStartsM/R/"
setwd(path)
# Generate cmds.txt
singleRunBashName <- "./randomisedStartsMSR.sh"
...
write.table(cmds, "/mnt/c/GitHub/SLiMTests/tests/newMotifs/paper1/randomisedStartsM/PBS/cmds.txt", 
