...
# Paths
R_PATH <- "~/tests/newMotifs/paper1/parallelSel/calcMutationStats/R/"
source(paste0(R_PATH, "helperFunctionsAndSetup.R"))
GDATA_PATH <- "/g/data/ht96/nb9894/newMotifs/paper1/parallelSel/"
COMBO_PATH <- "~/tests/newMotifs/R/"

WRITE_PATH <- "/scratch/ht96/nb9894/newMotifs/paper1/parallelSel/calcMutationStats/"
