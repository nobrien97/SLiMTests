...
JOBNAME=getH2
JOBNAME_PREFIX=newMotifs
BASEJOBNAME=${JOBNAME_PREFIX}/h2/${JOBNAME}                     # Where the files are saved to scratch
TOTALJOBNAME=${JOBNAME_PREFIX}/extraReplicates/h2/${JOBNAME}    # Where the final files are saved
...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir -p /scratch/ht96/nb9894/$BASEJOBNAME
...
cd /scratch/ht96/nb9894/$BASEJOBNAME  # Scratch files saved to scratch/newMotifs/h2 NOT scratch/newMotifs/extraReplicates...
