...
JOBNAME=h2/getH2
BASEJOBNAME=${SUBJOBNAME}/${JOBNAME}
TOTALJOBNAME=${SUBJOBNAME}/extraReplicates/${JOBNAME}
...
SCRATCHPATH=/scratch/ht96/nb9894/${BASEJOBNAME}
DATAPATH=/g/data/ht96/nb9894/${SUBJOBNAME}/extraReplicates
#DATAPATH=./
...
RSCRIPTNAME=$HOME/tests/${BASEJOBNAME}/R/calcH2.R
