...
WRITE_PATH <- paste0("/scratch/ht96/nb9894/newMotifs/randomisedStarts/calcLD/")
GDATA_PATH <- paste0("/g/data/ht96/nb9894/newMotifs/randomisedStarts/")
...
FNS_PATH <- "~/tests/newMotifs/randomisedStarts/calcMutationStats/R/"
...
source("~/tests/newMotifs/randomisedStarts/calcLD/R/LDHelpFns.R")
...
# Read in combos
d_combos <- read.table("~/tests/newMotifs/R/combos.csv", header = F,
                       col.names = c("model", "r"))
#testing
