...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir /scratch/ht96/nb9894/$JOBNAME/moreReps2
    mkdir /g/data/ht96/nb9894/$JOBNAME/moreReps2
    mkdir $HOME/tests/$JOBNAME/moreReps2/done
...
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/$JOBNAME/moreReps2
...
CMDS_PATH=$HOME/tests/$JOBNAME/moreReps2/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/$JOBNAME/moreReps2/
