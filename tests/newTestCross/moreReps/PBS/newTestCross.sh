...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir /scratch/ht96/nb9894/$JOBNAME/moreReps
    mkdir /g/data/ht96/nb9894/$JOBNAME/moreReps
    mkdir $HOME/tests/$JOBNAME/moreReps/done
...
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/$JOBNAME/moreReps
...
CMDS_PATH=$HOME/tests/$JOBNAME/moreReps/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/$JOBNAME/moreReps/
