...
JOBNAME=getH2
JOBNAME_PREFIX=newTestCross/additive/moreReps
...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir -p /scratch/ht96/nb9894/$JOBNAME_PREFIX/$JOBNAME
    mkdir -p /g/data/ht96/nb9894/$JOBNAME_PREFIX/$JOBNAME
    mkdir -p $HOME/tests/$JOBNAME_PREFIX/$JOBNAME/done
