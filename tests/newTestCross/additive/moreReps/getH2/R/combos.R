# File name
filename <- "./getH2_addMoreRepsSR.sh"
...
write.table(cmd_df, "/mnt/c/GitHub/SLiMTests/tests/newTestCross/additive/moreReps/getH2/PBS/cmds.txt", sep = " ", row.names = FALSE, col.names = FALSE, quote = FALSE)
