# Generate cmds.txt
singleRunBashName <- "./addMoreRepsSR.sh"
seeds <- 1:240
...
write.table(dfCMDs, "/mnt/c/GitHub/SLiMTests/tests/newTestCross/additive/moreReps/R/combos.csv", row.names = F, col.names = F)
...
write.table(cmds, "/mnt/c/GitHub/SLiMTests/tests/newTestCross/additive/moreReps/PBS/cmds.txt", sep = " ", row.names = FALSE, col.names = FALSE, quote = FALSE)
