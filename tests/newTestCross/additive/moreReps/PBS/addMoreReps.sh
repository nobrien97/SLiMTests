...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir -p /scratch/ht96/nb9894/$JOBNAME/additive/moreReps
    mkdir -p /g/data/ht96/nb9894/$JOBNAME/additive/moreReps
    mkdir -p $HOME/tests/$JOBNAME/additive/moreReps/done
...
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/$JOBNAME/additive/moreReps
...
CMDS_PATH=$HOME/tests/$JOBNAME/additive/moreReps/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/$JOBNAME/additive/moreReps/
