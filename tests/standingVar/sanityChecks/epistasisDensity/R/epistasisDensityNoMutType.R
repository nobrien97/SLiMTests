...
# Paths
GDATA_PATH <- "/g/data/ht96/nb9894/standingVar/sanityChecks/calcMutationStats/"
WRITE_PATH <- "/scratch/ht96/nb9894/standingVar/sanityChecks/epistasisDensity/"
EPISTASIS_DENSITY_FILE <- paste0(WRITE_PATH, "d_epi_nomut_density", model, ".csv")
EPISTASIS_WEIGHTED_DENSITY_FILE <- paste0(WRITE_PATH, "d_epi_nomut_freqweight_density", model, ".csv")
