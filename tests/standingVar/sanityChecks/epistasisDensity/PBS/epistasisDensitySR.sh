...
MODELINDEX=$1
FILENAME=${MODELINDEX}
JOBNAME=standingVar/sanityChecks/epistasisDensity
TESTDIR=$HOME/tests/$JOBNAME

echo "Beginning run modelindex = $MODELINDEX at $(date)"

RSCRIPTNAME=$HOME/tests/standingVar/sanityChecks/epistasisDensity/R/epistasisDensity.R
RSCRIPTNAME2=$HOME/tests/standingVar/sanityChecks/epistasisDensity/R/epistasisDensityNoMutType.R
