...
WRITE_PATH_MRR <- paste0("/scratch/ht96/nb9894/standingVar/sanityChecks/getH2/out_h2_", run, "_mrr.csv")
WRITE_PATH_MKR <- paste0("/scratch/ht96/nb9894/standingVar/sanityChecks/getH2/out_h2_", run, "_mkr.csv")
