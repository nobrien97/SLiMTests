...
ECHO=/bin/echo
SUBJOBNAME=standingVar/epistasisDensity
JOBNAME=epiPerMolComp
...
cat ./d_epi_mean_percomp* >> $SAVEDIR/d_epi_mean_percomp.csv
cat ./d_epi_freqweight_mean_percomp* >> $SAVEDIR/d_epi_freqweight_mean_percomp.csv
