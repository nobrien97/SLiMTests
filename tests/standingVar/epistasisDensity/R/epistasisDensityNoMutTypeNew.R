...
EPISTASIS_DENSITY_FILE <- paste0(WRITE_PATH, "d_epi_density_nomut_newEpi", model, ".csv")
EPISTASIS_WEIGHTED_DENSITY_FILE <- paste0(WRITE_PATH, "d_epi_freqweight_density_nomut_newEpi", model, ".csv")
