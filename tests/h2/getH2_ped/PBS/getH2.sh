...
# Make output folder
mkdir /scratch/ht96/nb9894/h2/getH2_ped
mkdir /g/data/ht96/nb9894/h2/getH2_ped
mkdir $HOME/tests/h2/getH2_ped/done

SAVEDIR=/g/data/ht96/nb9894/h2/getH2_ped
...
CMDS_PATH=$HOME/tests/h2/getH2_ped/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/h2/getH2_ped

cat ./*_done.csv >> $SAVEDIR/out_h2_ped.csv
