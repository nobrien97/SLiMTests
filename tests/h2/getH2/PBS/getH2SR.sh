...
SCRATCHPATH=/scratch/ht96/nb9894/h2/getH2
...
if [ -f $HOME/tests/h2/getH2/done/${RUN}_${CHUNK} ]; then
...
RSCRIPTNAME=$HOME/tests/h2/getH2/R/calcH2.R
...
touch $HOME/tests/h2/getH2/done/${RUN}_${CHUNK}
