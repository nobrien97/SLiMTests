...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir -p /scratch/ht96/nb9894/$JOBNAME/additive/neutral
    mkdir -p /g/data/ht96/nb9894/$JOBNAME/additive/neutral
    mkdir -p $HOME/tests/$JOBNAME/additive/neutral/done
...
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/$JOBNAME/additive/neutral
...
CMDS_PATH=$HOME/tests/$JOBNAME/additive/neutral/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/$JOBNAME/additive/neutral
