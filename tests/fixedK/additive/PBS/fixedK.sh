...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir -p /scratch/ht96/nb9894/$JOBNAME/additive
    mkdir -p /g/data/ht96/nb9894/$JOBNAME/additive
    mkdir -p $HOME/tests/$JOBNAME/additive/done
...
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/$JOBNAME/additive
...
CMDS_PATH=$HOME/tests/$JOBNAME/additive/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/$JOBNAME/additive
