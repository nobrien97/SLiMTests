...
# Make output folder
mkdir /scratch/ht96/nb9894/h2_hsfs/getH2_hsfs
mkdir /g/data/ht96/nb9894/h2_hsfs/getH2_hsfs
mkdir $HOME/tests/h2_hsfs/getH2_hsfs/done

SAVEDIR=/g/data/ht96/nb9894/h2_hsfs/getH2_hsfs
...
CMDS_PATH=$HOME/tests/h2_hsfs/getH2_hsfs/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/h2_hsfs/getH2_hsfs
