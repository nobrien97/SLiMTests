...
# e.g. qsub -v NJOBS=7 getH2_hsfs_nloci_split.sh
...
if [ X$NJOB == X ]; then
    ...
    # Make output folder
    mkdir /scratch/ht96/nb9894/h2_hsfs_nloci/getH2_hsfs_nloci
    mkdir /g/data/ht96/nb9894/h2_hsfs_nloci/getH2_hsfs_nloci
    mkdir $HOME/tests/h2_hsfs_nloci/getH2_hsfs_nloci/done
...
SAVEDIR=/g/data/ht96/nb9894/h2_hsfs_nloci/getH2_hsfs_nloci
...
CMDS_PATH=$HOME/tests/h2_hsfs_nloci/getH2_hsfs_nloci/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/h2_hsfs_nloci/getH2_hsfs_nloci
