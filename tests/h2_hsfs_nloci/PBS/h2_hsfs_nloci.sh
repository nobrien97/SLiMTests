...
# Make output folder
mkdir /scratch/ht96/nb9894/h2_hsfs_nloci
mkdir /g/data/ht96/nb9894/h2_hsfs_nloci
mkdir $HOME/tests/h2_hsfs_nloci/done

# Pre-job file manipulation goes here ...
# 
# INSERT CODE
cd $PBS_O_WORKDIR
SAVEDIR=/g/data/ht96/nb9894/h2_hsfs_nloci
...
CMDS_PATH=$HOME/tests/h2_hsfs_nloci/PBS/cmds.txt
...
cd /scratch/ht96/nb9894/h2_hsfs_nloci/
